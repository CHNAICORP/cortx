...
MCP_REGISTRY = {
    ...
    "brave-search": {
        ...
        "description": "Brave Search API 联网搜索（$5/月免费额度，需 API Key）",
        "category": "network",
        "install": {"command": "npx", "args": ["-y", "@brave/brave-search-mcp-server"]},
        "requires": "brave_api_key",
    },
    "zhipu-web-search": {
        "name": "智谱联网搜索 MCP",
        "description": "智谱 web-search-pro 联网搜索（国内直连，0.01元/次，SSE URL 直连 + Bearer Key）",
        "category": "network",
        "install": {},
        "url": "https://open.bigmodel.cn/api/mcp/web_search_pro/mcp",
        "requires": "zhipu_api_key",
    },
    "tavily": {
        "name": "Tavily MCP",
        "description": "Tavily 联网搜索（1000次/月免费，需 API Key）",
        "category": "network",
        "install": {"command": "npx", "args": ["-y", "tavily-mcp@latest"]},
        "requires": "tavily_api_key",
    },
    "exa": {
        "name": "Exa MCP",
        "description": "Exa 联网搜索（注册送 $20，托管 MCP 匿名可用）",
        "category": "network",
        "install": {},
    ...
    "firecrawl": {
        "name": "Firecrawl MCP",
        "description": "Firecrawl 联网搜索 + 网页抓取（1000次/月免费，需 API Key）",
        "category": "network",
        "install": {"command": "npx", "args": ["-y", "firecrawl-mcp"]},
